...
It is possible ask the main device for history data beyond the initial sync. This is done using the sock.fetchMessageHistory function.# api-bailyes-whatsapp
